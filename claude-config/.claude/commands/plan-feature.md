...
Break a feature into implementable stages before coding. For complex features with architectural decisions, consider using `/plan-product` which provides more detailed instructions.
...
- Sacrifice grammar for consiceness
