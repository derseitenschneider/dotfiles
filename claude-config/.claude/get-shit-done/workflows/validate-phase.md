...
```
Task(
  prompt="Read /Users/brianboy/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/brianboy/.claude/get-shit-done/templates/VALIDATION.md`
