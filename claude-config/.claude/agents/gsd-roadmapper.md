...
Reference full template: `/Users/brianboy/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/brianboy/.claude/get-shit-done/templates/state.md`.
